  ...
  iron: [
    {
      id: 'rally_master',
      name: 'Klaus Hern',
      title: 'Rally Director',
      emoji: '🔥',
      desc: 'Keeps the crowd hot. The Vanguard swells a little every turn.',
      effect: { stat: 'base', amount: 1 },
      likes: ['grassroots', 'zealot_rep', 'bloody_hands'],
      dislikes: ['dealmaker'],
    },
    {
      id: 'censor',
      ...
      title: 'Press Censor',
      emoji: '✂️',
      desc: 'Propaganda rises; so does the foreign scrutiny of why you need it.',
      effect: { stat: 'media', amount: 2 },
      likes: ['stonewaller', 'potemkin'],
      dislikes: ['press_friendly', 'honest_rep'],
    },
    {
      id: 'treasurer_iron',
      name: 'Mag. Blum',
      title: 'Movement Treasurer',
      emoji: '💷',
      desc: 'Money flows into the War Chest; where from is nobody’s business.',
      effect: { stat: 'funds', amount: 2 },
      likes: ['dark_money', 'owes_donor', 'corrupt_streak'],
      dislikes: ['clean_streak'],
    },
    {
      id: 'jurist',
      ...
      emoji: '⚖️',
      desc: 'Makes everything you do technically lawful. Cools one point of Exposure per turn.',
      effect: { stat: 'heat', amount: -2 },
      likes: ['clean_streak', 'pledged'],
      dislikes: ['went_negative'],
    },
  ],
  gilded: [
    {
      ...
      title: 'Tax Architect',
      emoji: '🧾',
      desc: 'Capital accumulates faster; so does the interest of auditors.',
      effect: { stat: 'funds', amount: 3 },
      likes: ['dark_money', 'owes_donor'],
      dislikes: ['clean_streak'],
    },
    {
      id: 'pr_chief',
      ...
      emoji: '🎙️',
      desc: 'Manages the face the public sees. Approval ticks up each turn.',
      effect: { stat: 'support', amount: 1 },
      likes: ['press_friendly', 'has_biographer'],
      dislikes: ['stonewaller'],
    },
    {
      id: 'fixer_gilded',
      ...
      title: 'The Fixer',
      emoji: '🕴️',
      desc: 'Leverage grows steadily. The methods are unspecified.',
      effect: { stat: 'influence', amount: 2 },
      likes: ['dealmaker', 'has_network', 'blackmailer'],
      dislikes: ['honest_rep'],
    },
    {
      id: 'regulator',
      name: 'Cmsr. Fell',
      title: 'Captured Regulator',
      emoji: '🛂',
      desc: 'Three points of Scrutiny cooled per turn. The Commissioner is very well compensated.',
      effect: { stat: 'heat', amount: -3 },
      likes: ['dark_money', 'owes_donor'],
      dislikes: ['went_negative'],
    },
  ],
  anointed: [
    {
      id: 'theologian',
      name: 'Brother Aldo',
      title: 'Chief Theologian',
      emoji: '📖',
      desc: 'Doctrine grows and Heresy cools. His interpretations are creative but internally consistent.',
      effect: { stat: 'media', amount: 2 },
      likes: ['zealot_rep', 'hardliner_cred'],
      dislikes: ['secret_reformer'],
    },
    {
      id: 'almoner',
      name: 'Sister Bex',
      title: 'Almoner-General',
      emoji: '🍞',
      desc: 'Tithes flow and the congregation feels the care. The Treasury ticks up each turn.',
      effect: { stat: 'funds', amount: 2 },
      likes: ['grassroots', 'honest_rep', 'peacemaker'],
      dislikes: ['corrupt_streak'],
    },
    {
      id: 'inquisitor',
      name: 'Grand Prior Wael',
      title: 'Prior of Discipline',
      emoji: '🗝️',
      desc: 'The Congregation tightens. So does the definition of heresy.',
      effect: { stat: 'base', amount: 1 },
      likes: ['bloody_hands', 'zealot_rep', 'own_cult'],
      dislikes: ['secret_reformer', 'peacemaker'],
    },
    {
      id: 'diplomat_faith',
      name: 'Envoy Cira',
      title: 'Secular Liaison',
      emoji: '🕊️',
      desc: 'Manages the Council’s relationship with the temporal world. Heresy accusations cool.',
      effect: { stat: 'heat', amount: -2 },
      likes: ['peacemaker', 'clean_streak', 'dealmaker'],
      dislikes: ['went_negative'],
    },
  ],
};
